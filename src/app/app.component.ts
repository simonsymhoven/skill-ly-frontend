...
export class AppComponent implements OnInit, OnDestroy
{
    ...
    )
    {
        ...
        // Add languages
        this._translateService.addLangs(['en', 'de', 'es']);

        // Set the default language
        this._translateService.setDefaultLang('cd');

        // Set the navigation translations
        this._fuseTranslationLoaderService.loadTranslations(navigationEnglish, navigationGerman, navigationSpanish);
